...
public class MainActivity extends Activity {
    ...
    public void playAd2 (View v) {
        ...
        banner1Holder.addView(webPlayer);
        webPlayer.setup();
        webPlayer.loadHTML("http://172.16.1.39:3003/mraidad/index.html", ad2);
    }
    ...
    public void playAd4 (View v) {
        ...
        banner1Holder.addView(webPlayer);
        webPlayer.setup();
        webPlayer.loadHTML("http://172.16.1.39:3003/mraidad/index.html", ad4);
    }
    ...
    public void playAd5 (View v) {
        ...
        banner1Holder.addView(webPlayer);
        webPlayer.setup();
        webPlayer.loadHTML("http://172.16.1.39:3003/mraidad/index.html", ad5);
    }
