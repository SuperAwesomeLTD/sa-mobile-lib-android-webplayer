...
public class SAMRAID {
    ...
    public void setResizeProperties (Map<String, String> params) {
        String width = params.get("width");
        String height = params.get("height");
        if (width != null && height != null) {
            try {
                expandedWidth = Integer.parseInt(width);
            } catch (Exception e) {
                //
            }
            try {
                expandedHeight = Integer.parseInt(height);
            } catch (Exception e) {
                //
            }
        }
        ...
        if (customClosePosition != null) {
            switch (customClosePosition) {
                case "top-left": closeButtonPosition = CloseButtonPosition.TOP_LEFT; break;
                case "top_right": closeButtonPosition = CloseButtonPosition.TOP_RIGHT; break;
                case "center": closeButtonPosition = CloseButtonPosition.CENTER; break;
                case "bottom-left": closeButtonPosition = CloseButtonPosition.BOTTOM_LEFT; break;
                case "bottom-right": closeButtonPosition = CloseButtonPosition.BOTTOM_RIGHT; break;
                case "top-center": closeButtonPosition = CloseButtonPosition.TOP_CENTER; break;
                case "bottom-center": closeButtonPosition = CloseButtonPosition.BOTTOM_CENTER; break;
                default: closeButtonPosition = CloseButtonPosition.TOP_RIGHT; break;
            }
        }
    }
    ...
    public void setCloseButtonPosition(CloseButtonPosition pos) {
        closeButtonPosition = pos;
    }
